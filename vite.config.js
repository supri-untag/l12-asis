    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/js/page/go_promise/student_go_promise.js',
                'resources/js/page/go_promise/admin_go_promise.js',
                'resources/js/page/go_promise/student_go_promise_edit.js',
            ],
            refresh: true,
        }),
        tailwindcss(),
