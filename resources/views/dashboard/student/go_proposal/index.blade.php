...
@section('meta')
    <title>SiAsis -  Proposal Tesis</title>
@endsection
@section('app_content')
    @if($hasThesis)
                ...
                <div class="col-md-12 col-xl-12">
                    ...
                    <a href="#" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            @switch($thesis_detail->status_proposal)
                                @case(1)
                                    <!--begin::Card toolbar-->
                        ...
                        <div class="card-body p-9">
                            ...
                            <div class="d-flex flex-wrap mb-5">
                                ...
                                <div
                                    ...
                                    <p data-bs-toggle="modal" data-bs-target="#kt_modal_detail">{{$thesis_detail->title_proposal}}</p>
                                </div>
                                <!--end::Due-->
                                <!--begin::Budget-->
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body pt-0 pb-15 px-5 px-xl-20">
                            ...
                            <div class="mb-13 text-center">
                                <h1 class="mb-3"> {{$thesis_detail->students->name}} - Judul : {{$thesis_detail->title_proposal}}</h1>
                            ...
                            <div class="card">
                                <!--begin::Form-->
                                <form id="kt_go_proposal_detail" class="form" action="#" method="post" data-kt-redirect-url="{{route('StudentGoProposal')}}">
                                    @csrf
                                    <!--begin::Card body-->
                                    <div class="card-body p-9">
                                        <!--begin::Row-->
                                            ...
                                            <div class="row mb-8">
                                                ...
                                                <div class="col-xl-9 fv-row">
                                                    <select
                                                        ...
                                                        @if($thesis_detail->disabled_proposal== 1)
                                                            disabled
                                                        @endif
                                            ...
                                            <div class="col-xl-9 fv-row">
                                                <textarea
                                                    @if($thesis_detail->disabled_proposal== 1)
                                                        disabled
                                                    @endif
                                                    name="title_proposal" class="form-control h-100px">{{$thesis_detail->title_proposal}}</textarea>
                                            </div>
                                            <!--begin::Col-->
                                        </div>
                                        <!--end::Row-->
                            ...
                            <div class="d-flex flex-center flex-row-fluid pt-12">
                                ...
                                <button
                                    @if($thesis_detail->disabled_proposal== 1)
                                        disabled
                                    @endif
                                    type="submit" class="btn btn-primary" id="kt_edit_go_proposal_button">
