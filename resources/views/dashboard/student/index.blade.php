                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body pt-0 pb-15 px-5 px-xl-20">
                                    ...
                                    <div class="card-body p-9">
                                        ...
                                        <div class="row mb-8">
                                            ...
                                            <div class="row mb-8">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-xl-9 fv-row">
                                                    <select disabled class="form-select" name="promotor" data-control="select2" data-placeholder="==== Pilih Dosen Pembimbing====">
                                        ...
                                        <div class="row mb-8">
                                            ...
                                            <!--begin::Col-->
                                            <div class="col-xl-9 fv-row">
                                                <textarea disabled  name="title_promise" class="form-control h-100px">{{$thesis_detail->title_promise}}</textarea>
                                            </div>
                                            <!--begin::Col-->
                                        </div>
                                        <!--end::Row-->
                                        ...
                                        <div class="row mb-8">
                                            ...
                                            <!--begin::Col-->
                                            <div class="col-xl-9 fv-row">
                                                <textarea disabled name="das_sein" class="form-control h-100px">{{$thesis_detail->das_sein}}</textarea>
                                            </div>
                                            <!--begin::Col-->
                                        </div>
                                        <!--end::Row-->
                                        ...
                                        <div class="row mb-8">
                                            ...
                                            <!--begin::Col-->
                                            <div class="col-xl-9 fv-row">
                                                <textarea disabled  name="das_sollen" class="form-control h-100px">{{$thesis_detail->das_sollen}}</textarea>
                                            </div>
                                            <!--begin::Col-->
                                        </div>
                                        <!--end::Row-->
                                        ...
                                        <div class="row mb-8">
                                            ...
                                            <!--begin::Col-->
                                            <div class="col-xl-9 fv-row">
                                                <textarea disabled name="gaps" class="form-control h-100px">{{$thesis_detail->gaps}}</textarea>
                                            </div>
                                            <!--begin::Col-->
                                        </div>
                                        <!--end::Row-->
                                        ...
                                        <div class="row mb-8">
                                            ...
                                            <!--begin::Col-->
                                            <div class="col-xl-9 fv-row">
                                                <textarea disabled name="formulation" class="form-control h-100px">{{$thesis_detail->formulation}}</textarea>
                                            </div>
                                            <!--begin::Col-->
                                        </div>
                                        <!--end::Row-->
                            ...
                            <div class="d-flex flex-center flex-row-fluid pt-12">
                                ...
                                <button type="submit" class="btn btn-primary" id="kt_edit_go_promise_button">
