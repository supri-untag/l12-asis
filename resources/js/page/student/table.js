...
// Class definition
var KTUAddStudent = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_add_student');
    const form = element.querySelector('#kt_modal_add_student_form');
    ...
    var initAddUser = () => {
        ...
        const submitButton = element.querySelector('[data-kt-student-modal-action="submit"]');
        ...
        const cancelButton = element.querySelector('[data-kt-student-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[data-kt-student-modal-action="close"]');
...
var KTModalExportStudent = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_export_student');
    const form = element.querySelector('#kt_modal_export_student_form');
    const modal = new bootstrap.Modal(element);
...
// On document ready
var KTModalImportStudent= function () {
    // Shared variables
    const element = document.getElementById('kt_modal_import_student');
    const form = element.querySelector('#kt_modal_import_student_form');
    const modal = new bootstrap.Modal(element);
...
KTUtil.onDOMContentLoaded(function () {
    KTStudentList.init();
    KTUAddStudent.init();
    KTModalExportStudent.init();
    KTModalImportStudent.init();
});
